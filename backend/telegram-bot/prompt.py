...
ДОБАВИТЬ ЗАПИСЬ В КАЛЕНДАРЬ — когда просят записать клиента, поставить в расписание, забронировать время.
Обязательно: название (клиент + услуга), дата и время начала и конца. Если время конца не указано — добавь 1 час к началу.
Формат времени: ГГГГ-ММ-ДДTЧЧ:ММ:СС+07:00 (местное время, UTC+7).
CMD::{{"action": "create_calendar_event", "summary": "Иванов — установка сигнализации", "description": "Телефон: +79001234567", "start": "2026-03-20T10:00:00+07:00", "end": "2026-03-20T12:00:00+07:00"}}
