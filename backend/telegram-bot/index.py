...
BUTTON_MAP = {
    ...
    "💰 Финансовый отчёт": "Сформируй финансовый отчёт за текущий месяц: доходы, расходы, прибыль, детализация",
    "➕ Создать заявку": "Хочу создать новую заявку",
    "📊 Сводка по кассам": "Покажи текущие остатки по всем кассам",
    "💸 Расходы": "Покажи все последние расходы с датами, суммами, категориями и комментариями",
    "📦 Склад": "Покажи остатки товаров на складе",
}
