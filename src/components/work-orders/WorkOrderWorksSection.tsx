                ...
                <tr key={w.id || i} className="group hover:bg-muted/30">
                  {editingId === w.id ? (
                    <>
                      ...
                      <td className="px-3 py-1.5"><Input type="number" step="0.1" className="h-8 w-20 text-sm text-center" value={editForm.norm_hours || ""} onChange={(e) => setEditForm((f) => ({ ...f, norm_hours: Number(e.target.value) }))} /></td>
                      <td className="px-3 py-1.5"><Input type="number" className="h-8 w-24 text-sm text-right" value={editForm.norm_hour_price || ""} onChange={(e) => setEditForm((f) => ({ ...f, norm_hour_price: Number(e.target.value) }))} /></td>
                      ...
                      <td className="px-3 py-1.5"><Input type="number" className="h-8 w-28 text-sm text-right" value={editForm.price || ""} onChange={(e) => setEditForm((f) => ({ ...f, price: Number(e.target.value) }))} /></td>
                      <td className="px-3 py-1.5">
                    ...
                    <>
                      ...
                      <td className="px-3 py-1.5 text-center">{w.norm_hours || "—"}</td>
